...
export default function TwitchTasks() {
  const navigate = useNavigate();
  const [allTasks, setAllTasks] = React.useState([]);

  const defaultTasks = [
    { id: 1, title: 'Follow channel', reward: '1.5 mlpts' },
  ...
  React.useEffect(() => {
    ...
    if (miningTasks['twitch'] && Array.isArray(miningTasks['twitch'])) {
      miningTasks['twitch'].forEach(task => {
        tasks.push({
          id: task.id,
      ...
      <div style={{ flex: '1', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div className="p-6" style={{ flex: '0 0 auto', overflowY: 'auto' }}>
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            />
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Twitch Tasks</h1>
