...
export default function InstagramTasks() {
  const navigate = useNavigate();
  const [allTasks, setAllTasks] = React.useState([]);

  const defaultTasks = [
    { id: 1, title: 'Follow on Instagram', reward: '13.551 mlpts' },
    { id: 2, title: 'Like and comment on posts', reward: '0.08 mlpts' },
  ];
  ...
  React.useEffect(() => {
    ...
    if (miningTasks['instagram'] && Array.isArray(miningTasks['instagram'])) {
      miningTasks['instagram'].forEach(task => {
        tasks.push({
          id: task.id,
      ...
      <div style={{ flex: '1', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div className="p-6" style={{ flex: '0 0 auto', overflowY: 'auto' }}>
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            />
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Instagram Tasks</h1>
