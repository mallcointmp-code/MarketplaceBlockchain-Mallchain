...
export default function TikTokTasks() {
  ...
  const defaultTasks = [
    { id: 1, title: 'Watch video and earn Mallpoints', reward: '0.008 mlpts' },
    { id: 2, title: 'Video and earn mallpoints', reward: '0.39 mlpts' },
  ];
  ...
  React.useEffect(() => {
    ...
    if (miningTasks['tiktok'] && Array.isArray(miningTasks['tiktok'])) {
      miningTasks['tiktok'].forEach(task => {
        tasks.push({
          id: task.id,
      ...
      <div style={{ flex: '1', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div className="p-6" style={{ flex: '0 0 auto', overflowY: 'auto' }}>
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            />
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">TikTok Tasks</h1>
