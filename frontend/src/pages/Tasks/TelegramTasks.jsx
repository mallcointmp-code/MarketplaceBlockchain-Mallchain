...
export default function TelegramTasks() {
  const navigate = useNavigate();
  const [allTasks, setAllTasks] = React.useState([]);

  const defaultTasks = [
    { id: 1, title: 'Follow the Mallcoin channel', reward: '8.5 mlpts' },
    { id: 2, title: 'Join the group', reward: '3 mlpts' },
  ];
  ...
  React.useEffect(() => {
    ...
    if (miningTasks['telegram'] && Array.isArray(miningTasks['telegram'])) {
      miningTasks['telegram'].forEach(task => {
        tasks.push({
          id: task.id,
      ...
      <div style={{ flex: '1', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div className="p-6" style={{ flex: '0 0 auto', overflowY: 'auto' }}>
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            />
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Telegram Tasks</h1>
